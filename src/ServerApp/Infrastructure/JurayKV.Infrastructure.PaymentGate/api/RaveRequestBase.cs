...
namespace JurayKV.Infrastructure.PaymentGateapi
{
        ...
        protected RaveRequestBase()
        {
            ...
            HttpClient = new HttpClient
            {
                BaseAddress = Config.IsLive
                    ? new Uri(JurayKV.Infrastructure.PaymentGateconfig.Const.LiveUrl)
                    : new Uri(JurayKV.Infrastructure.PaymentGateconfig.Const.SanboxUrl)
            };
